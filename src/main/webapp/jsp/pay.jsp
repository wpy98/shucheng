    ...
    <tr align="center">
        <td>
            <table cellspacing="20px">
                <tr>
                    <td>
                        <div style="color: red">需要支付:${requestScope.sum}</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr>
                    <td>
                        ...
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/bc.bmp" align="middle" />
                    </td>
                    <td>
                        <input type="radio" name="pd_FrpId" value="ABC-NET-B2C" />农业银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/abc.bmp" align="middle" />
                    </td>
                    <td>
                        <input type="radio" name="pd_FrpId" value="ICBC-NET-B2C" checked="checked" />工商银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/icbc.bmp" align="middle" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="radio" name="pd_FrpId" value="BOCO-NET-B2C" />交通银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/bcc.bmp" align="middle" />
                    </td>
                    <td>
                        <input type="radio" name="pd_FrpId" value="PINGANBANK-NET" />平安银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/pingan.bmp" align="middle" />
                    </td>
                    <td>
                        <input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />建设银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/ccb.bmp" align="middle" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="radio" name="pd_FrpId" value="CEB-NET-B2C" />光大银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/guangda.bmp" align="middle" />
                    </td>
                    <td>
                        <input type="radio" name="pd_FrpId" value="CMBCHINA-NET-B2C" />招商银行
                        <img src="${pageContext.request.contextPath}/HTML/bank_img/cmb.bmp" align="middle" />
                    </td>
                    <td></td>
                </tr>
                <tr align="right">
                    <td colspan="3" >
                        <a href="${pageContext.request.contextPath}/jsp/success.jsp">
                            <img src="${pageContext.request.contextPath}/HTML/img/quedingfukuan.png" width="100px" height="30px" />
                        </a>
                    </td>
                </tr>
